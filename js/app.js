 ...
 * layer in order to get many results if possible. (Might need to exclude "X", but "Z" works)
 * Need to define the DOM elements to be filled in on click. Also need to define ajax queries
 * with JQuery.
 */
